package com.ddarji.lab10_1.hashing;
...
public class HashingActivity extends AppCompatActivity {
    ...
    public void hashresult_click(View view) throws NoSuchAlgorithmException, UnsupportedEncodingException {

        byte[] input, output1, output2, output3, output4, output5;

        // create hash code
        input = inputText.getText().toString().getBytes();
        Log.i("DARJI INPUT TEXT", inputText.getText().toString());
        ...
        Log.i("DARJI MD5 OUTPUT ", hexString1.toString());
        ...
        Log.i("DARJI SHA1 OUTPUT ", hexString2.toString());
        ...
        Log.i("DARJI SHA256 OUTPUT ", hexString3.toString());
        ...
        Log.i("DARJI SHA384 OUTPUT ", hexString4.toString());
        ...
        Log.i("DARJI SHA512 OUTPUT ", hexString5.toString());
    ...
    public void compareresult_click(View view) throws NoSuchAlgorithmException, UnsupportedEncodingException {
